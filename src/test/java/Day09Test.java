...
public class Day09Test {
  ...
  public static void setUp() throws FileNotFoundException {
    inputTestLines = FileUtils.readLines(Paths.get("src", "test", "resources", "day09", "input-test.txt"));
    inputTest2Lines = FileUtils.readLines(Paths.get("src", "test", "resources", "day09", "input-test-2.txt"));
    inputLines = FileUtils.readLines(Paths.get("src", "test", "resources", "day09", "input.txt"));
  }
